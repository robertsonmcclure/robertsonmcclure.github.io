...
[Atom][4] has got you covered, you unhappy with pre-existing styles complainer. Any feature a theme that you've installed can be over written by going to the Config Folder, a link can be found in the Settings Page, and simply editing the code that runs [Atom][4]. Yes, [Atom][4] was built using HTML, CSS, JavaScript and Node.js. You can very well change how [Atom][4] runs by simply editing the code that runs it. This is why they advertise [Atom][4] as **_a hackable editor_**.
